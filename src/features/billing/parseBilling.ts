  ...
  return {
    ...
    asaasSubscriptionId:
      typeof o.asaasSubscriptionId === 'string'
        ? o.asaasSubscriptionId
        : undefined,
    nextDueDate:
      typeof o.nextDueDate === 'string' ? o.nextDueDate : undefined,
    trialEndsAt:
      typeof o.trialEndsAt === 'string' ? o.trialEndsAt : undefined,
    ...
    lastEventAt:
      typeof o.lastEventAt === 'string' ? o.lastEventAt : undefined,
  }
}
