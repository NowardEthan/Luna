...
def _provider_order(auth_mode: str = "cloud") -> list[str]:
    ...
    if not env_bool("LLM_CLOUD_ENABLED", "1") or env_bool("LLM_LOCAL_ONLY", "0"):
        return ["ollama"]
    chains = {
        "openrouter": ["openrouter", "groq", "together", "ollama"],
        "ollama": ["ollama", "openrouter", "groq", "together"],
        "groq": ["groq", "openrouter", "together", "ollama"],
        "together": ["together", "openrouter", "groq", "ollama"],
    }
